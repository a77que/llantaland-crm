...
async function main() {
  ...
  // ── Productos ─────────────────────────────────────────────────
  const productosData = [
    { sku: 'BRID-195-65R15-EP150',  medida: '195/65R15', marca: 'Bridgestone', nombreComercial: 'Ecopia EP150',      grupo: 'Turismo',  tipo: 'AUTO',      precioRegular: 320, precioOferta: null,  stock: { L0:30, L1:8, L2:6, L3:4, L4:3, L5:5 } },
    { sku: 'MICH-195-65R15-E3',     medida: '195/65R15', marca: 'Michelin',    nombreComercial: 'Energy E3',         grupo: 'Turismo',  tipo: 'AUTO',      precioRegular: 380, precioOferta: 350,   stock: { L0:20, L1:5, L2:5, L3:3, L4:2, L5:4 } },
    { sku: 'CONT-195-65R15-CC',     medida: '195/65R15', marca: 'Continental', nombreComercial: 'ContiContact',      grupo: 'Turismo',  tipo: 'AUTO',      precioRegular: 360, precioOferta: null,  stock: { L0:15, L1:4, L2:3, L3:2, L4:3, L5:2 } },
    { sku: 'GOOR-175-70R13-AS',     medida: '175/70R13', marca: 'Goodyear',    nombreComercial: 'Assurance',         grupo: 'Turismo',  tipo: 'AUTO',      precioRegular: 220, precioOferta: null,  stock: { L0:40, L1:10, L2:8, L3:6, L4:4, L5:6 } },
    { sku: 'BRID-185-60R14-EP150',  medida: '185/60R14', marca: 'Bridgestone', nombreComercial: 'Ecopia EP150',      grupo: 'Turismo',  tipo: 'AUTO',      precioRegular: 290, precioOferta: 270,   stock: { L0:25, L1:6, L2:5, L3:4, L4:3, L5:4 } },
    { sku: 'MICH-205-55R16-P3',     medida: '205/55R16', marca: 'Michelin',    nombreComercial: 'Primacy 3',         grupo: 'Turismo',  tipo: 'AUTO',      precioRegular: 450, precioOferta: null,  stock: { L0:18, L1:4, L2:4, L3:3, L4:2, L5:3 } },
    { sku: 'PIRE-205-55R16-P7',     medida: '205/55R16', marca: 'Pirelli',     nombreComercial: 'P7 Cinturato',      grupo: 'Turismo',  tipo: 'AUTO',      precioRegular: 480, precioOferta: 440,   stock: { L0:12, L1:3, L2:3, L3:2, L4:2, L5:2 } },
    { sku: 'HANK-205-55R16-K125',   medida: '205/55R16', marca: 'Hankook',     nombreComercial: 'Kinergy GT K125',   grupo: 'Turismo',  tipo: 'AUTO',      precioRegular: 310, precioOferta: 280,   stock: { L0:22, L1:5, L2:5, L3:4, L4:3, L5:3 } },
    { sku: 'MICH-265-70R17-LTX',    medida: '265/70R17', marca: 'Michelin',    nombreComercial: 'LTX Force',         grupo: 'SUV/4x4', tipo: 'CAMIONETA',  precioRegular: 580, precioOferta: null,  stock: { L0:20, L1:5, L2:4, L3:3, L4:2, L5:3 } },
    { sku: 'CONT-265-70R17-CCA',    medida: '265/70R17', marca: 'Continental', nombreComercial: 'CrossContact ATR',  grupo: 'SUV/4x4', tipo: 'CAMIONETA',  precioRegular: 560, precioOferta: 520,   stock: { L0:16, L1:4, L2:3, L3:2, L4:2, L5:2 } },
    { sku: 'BRID-265-70R17-D840',   medida: '265/70R17', marca: 'Bridgestone', nombreComercial: 'Dueler D840',       grupo: 'SUV/4x4', tipo: 'CAMIONETA',  precioRegular: 540, precioOferta: null,  stock: { L0:12, L1:3, L2:3, L3:2, L4:2, L5:2 } },
    { sku: 'GOOR-245-70R16-WRSP',   medida: '245/70R16', marca: 'Goodyear',    nombreComercial: 'Wrangler HP',       grupo: 'SUV/4x4', tipo: 'CAMIONETA',  precioRegular: 490, precioOferta: 460,   stock: { L0:10, L1:3, L2:2, L3:2, L4:1, L5:2 } },
    { sku: 'MICH-225-60R17-PRI',    medida: '225/60R17', marca: 'Michelin',    nombreComercial: 'Primacy SUV',       grupo: 'SUV/4x4', tipo: 'CAMIONETA',  precioRegular: 520, precioOferta: null,  stock: { L0:14, L1:4, L2:3, L3:2, L4:2, L5:3 } },
    { sku: 'BRID-11R22-R152',       medida: '11R22.5',   marca: 'Bridgestone', nombreComercial: 'R152 II',           grupo: 'Comercial',tipo: 'CAMION',     precioRegular: 1200,precioOferta: null,  stock: { L0:20, L1:2, L2:1, L3:1, L4:0, L5:1 } },
    { sku: 'MICH-315-80R22-XZA3',   medida: '315/80R22', marca: 'Michelin',    nombreComercial: 'XZA3',              grupo: 'Comercial',tipo: 'CAMION',     precioRegular: 1450,precioOferta: 1380,  stock: { L0:15, L1:1, L2:1, L3:0, L4:0, L5:1 } },
  ];
